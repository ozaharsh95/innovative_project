...
const questions = [
    {
        title : 'Who are the CM of Gujrat ?',
        options : [
            'Shree Narendra Modi', 
            'Shree Vijay Rupani', 
            'Shree Bhupendrabhai Patel', 
            'Shree Amit Shah'
        ],
        answer : '2',
        score : 1
    ...
    {
        title : 'Which of the following are not Hardware components of Computer ?',
        options : [
        	'Ubuntu',
            'Mouse',
            'Desktop',
    ...
    {
        title : 'which network layer is used by end-user software?',
        options : [
            'Data-link',
            'Application',
            'Transport',
    ...
    {
        title : 'which is the longest river in gujrat? ?',
        options : [
            'Sabarmati',
            'Narmada',
            'Mahi',
